...
//Game::Game(const std::string& name, unsigned int player_count, unsigned int starting_money) {
//    this->player_count = player_count;
//    players.push_back(std::make_unique<HumanPlayer>(name, starting_money, 0));
//    for (unsigned int i = 1; i < player_count; ++i) {
//        players.push_back(std::make_unique<BotPlayer>("Bot " + std::to_string(i), starting_money, 0));
//    }
//
